...
const helpDialog = require('./help')(bot, builder);
const localeDialog = require('./locale')(bot, builder);
const salesforceDialog = require('./salesforce')(bot, builder);
const helpdeskDialog = require('./helpdesk')(bot, builder);
const cioDialog = require('./cio')(bot, builder);
